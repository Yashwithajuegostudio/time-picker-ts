...
import { ACTIVE_STATUS, HOUR_VALUES, MINUTE_VALUES, TITLE } from '../utils/constant';
import { TimePickerBox, TimePickerContainer, TimePickerHeader } from './TimePicker.style'
...
export const TimePicker:React.FC = () => {
    ...
    <TimePickerContainer>
     <TimePickerHeader>
    <Button title={hourValue === "" ? TITLE.hourTitle : hourValue}  active={
